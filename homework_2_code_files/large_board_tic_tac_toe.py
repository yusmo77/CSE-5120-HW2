...
class RandomBoardTicTacToe:
    ...
    def play_ai(self):
        ...
        if value is None or best_move is None:
            return self.game_state.get_scores()
        
        """ USE self.game_state.get_scores(terminal) HERE TO COMPUTE AND DISPLAY THE FINAL SCORES """
        self.move(best_move)
        self.game_state.board_state[best_move[0]][best_move[1]] = -1
        self.draw_circle(best_move[0], best_move[1])  
        ai_move = best_move[0], best_move[1]
        self.moves_taken.append(ai_move)
        self.change_turn()
                ...
                #Checks if user clicked mouse.
                    ...
                    if self.start_button_rect.collidepoint(pos):
                        ...
                        if grid_y >= 0 and self.game_state.board_state[grid_x][grid_y] == 0:
                            ...
                            self.moves_taken.append([grid_x, grid_y])
                            self.play_ai()
                    """
